...
export default function FlashCards({images}: {
    ...
    return (
        <div onClick={onImageClick} className="relative w-110 h-75 group">
            ...
            <div 
                className="w-110 h-75 outline outline-gray-300 outline-3 bg-gray-200 rotate-4 
                rounded-xl -translate-y-7 translate-x-9 transition group-hover:-translate-y-9

...
export function IconLinkButton({title, href, src}: {
    ...
    return (
        <a target="_blank" href={href} className="flex flex-row font-bold hover:!text-sky-600 p-default decoration-sky-300 items-center space-x-2 hover:outline p-2 rounded-md hover:outline-sky-300 hover:bg-sky-100 active:bg-sky-200">
